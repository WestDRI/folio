...
<span style="font-size:1.8em;">https://folio.vastcloud.org/imagemagick</span>
...
## Take-home exercise
Write a bash script to crop ten random 500x500 images out of `forest.avif`. There is a
solution somewhere [on this page](/pytables), but check it only after you write
your own script.
:::
...
- <https://usage.imagemagick.org>{target="_blank"}
- <https://en.wikipedia.org/wiki/ImageMagick>{target="_blank"}
- <https://imagemagick.org/script/command-line-tools.php>{target="_blank"}
- <http://www.imagemagick.org/script/command-line-options.php>{target="_blank"}
- <https://imagemagick.org/script/stream.php>{target="_blank"}
- [Imagemagick cheatsheet](https://devhints.io/imagemagick){target="_blank"}
- <https://github.com/yangboz/imagemagick-cheatsheet>{target="_blank"}
