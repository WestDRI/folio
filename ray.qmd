...
current Ray cluster? **Hint**: look into the information returned by `ray.nodes()`.
:::
...
::: {.callout-caution collapse="true"}
## BIG ONE: combining Numba and Ray remotes for the slow series
...
::: {.callout-note}
This example works on my computer (`pyenv activate hpc-env`), but not on the training cluster where
...
- [Distributed and Parallel Training Tutorials](https://pytorch.org/tutorials/distributed/home.html){target="_blank"}
