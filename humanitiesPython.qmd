...
<span style="font-size:1.8em;">https://folio.vastcloud.org/humanitiespython</span>
...
relax and watch the presentation. The [three followup
sessions](https://hss24.netlify.app/program/#february-26-28){target="_blank"} on February 26-28 will teach you
Python with many hands-on exercises (6 hours in total).
...
In tomorrow's [3D Visualization workshop](https://hss24.netlify.app/program/#february-16){target="_blank"} you
will see some more complex text manipulation.
...
You can find many more examples [here](https://realpython.com/python-time-module){target="_blank"}.
...
- [Matplotlib](https://matplotlib.org/stable/gallery){target="_blank"} is a good starting point, creates
  non-interactive images and movies
- [Plotly](https://plotly.com/python){target="_blank"} if you want HTML interactivity
- [Seaborn](https://seaborn.pydata.org/examples){target="_blank"} is based on matplotlib with a high-level
  interface for statistical graphics
- [Plotnine](https://plotnine.org/gallery){target="_blank"} is an implementation of a grammar of graphics in
  Python based on R's ggplot2

If you want more advanced 3D rendering, in Python there are libraries to create [3D scientific
visualizations](https://ccvis.netlify.app){target="_blank"}, and in the Alliance federation we provide
free-of-charge support should you require help with these tools.

In tomorrow's [3D Visualization workshop](https://hss24.netlify.app/program/#february-16){target="_blank"} I
will demo using Python for analyzing a set of texts, building a global dictionary for all these texts,
positioning each paragraph in this dictionary, and then visualizing differences between these paragraphs'
vocabularies as a 3D scatter plot:

:::{style="text-align: center;"}
![Four English and four Greek texts, each node representing a paragraph](/fig/withGospels.png){width=90%}
:::

and as a 3D graph:

:::{style="text-align: center;"}
![Lines connect paragraphs with at least 15 words in common](/fig/a5.png){width=90%}
:::
...
- [Python Tutorials for Digital
  Humanities](https://www.youtube.com/c/pythontutorialsfordigitalhumanities){target="_blank"} by William
  Mattingly
- [2024 HSS Winter Series playlist](https://www.youtube.com/playlist?list=PL2jE_DQZemnU6WqEpqWaYQsjhyheDsVsc){target="_blank"}
