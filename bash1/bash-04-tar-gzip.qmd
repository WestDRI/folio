...
<!-- 04-archives.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/ckD5jOCnyBU){target="_blank"} after the workshop.
:::
...
DAR, please watch our
[DAR webinar](https://training.westdri.ca/tools/rdm#dar){target="_blank"} (scroll down to see it), or check our
[DAR documentation page](https://docs.alliancecan.ca/wiki/Dar){target="_blank"}.
