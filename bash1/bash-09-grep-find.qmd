...
<!-- 09-grep.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/mbZ8nB-V4zQ){target="_blank"} after the workshop.
:::
...
::: {.callout-caution collapse="true"}
## Question Somewhat tricky problem
...
<!-- 09-find.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/AnwsnESj82Q){target="_blank"} after the workshop.
:::
...
<!-- 09-findgrep.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/aFrMKkjMIHY){target="_blank"} after the workshop.
:::
