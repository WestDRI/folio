...
<!-- 08-scripts.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/UGZI6_HDyDc){target="_blank"} after the workshop.
:::

<!-- 08-script-molecules.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/rNnrcqkhXQo){target="_blank"} after the workshop.
:::
...
<!-- 08-variables.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/nNf4Xb56yEs){target="_blank"} after the workshop.
:::
...
<!-- 08-functions.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/gSCRWUG9fy4){target="_blank"} after the workshop.
:::
