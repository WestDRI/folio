...
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/4IkHY84uUss){target="_blank"} after the workshop.
:::
...
<!-- 10-awk.mkv -->
::: {.callout-note}
You can [watch a video for this topic](https://youtu.be/BMrL7zoyJH8){target="_blank"} after the workshop.
:::
