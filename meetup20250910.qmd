...
Divide the entire range `2..n` into 100 groups. In each group, the first 9 items are processed on the GPU, and
the last item on the CPU in serial -- a nice demo of Amdahl's Law.
