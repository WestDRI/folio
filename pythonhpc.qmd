...
**June 13<sup>th</sup>, 9:30am–12:30pm and 1:30pm-4:30pm Pacific Time**
...
launch new threads. Here is a [full example of the slow series calculation](/files/sum.py){target="_blank"}
that instead uses `ThreadPoolExecutor()` function
