...
<span style="font-size:1.8em;">https://folio.vastcloud.org/git-rcg</span>
...
- RCG website <https://www.rcg.sfu.ca>{target="_blank"}
  - main repo <https://github.sfu.ca/its/rcg-website>
  - my fork <https://github.sfu.ca/alexeir/rcg-website.git>
- Marie's excellent [Git course](https://mint.westdri.ca/git/top_intro){target="_blank"}
- [Some reading](https://devopscube.com/set-git-upstream-respository-branch){target="_blank"} on the GitHub's pull requests
  workflow
...
- Open <https://github.sfu.ca/username/rcg-website/branches>{target="_blank"} and delete `idea` branch

### Working directly on GitHub for small edits

Open <https://github.sfu.ca/its/rcg-website>{target="_blank"} in your web browser and start editing a
file. Since most likely you don't have direct write access, GitHub will automatically clone the repo and start
a new branch with your change.
