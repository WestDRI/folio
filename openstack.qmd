...
requested, and they will use your existing allocation.
...
::: {.callout-note}
- For critical workloads, it is better to stop the VM first or ensure the filesystem is flushed.
- Snapshots save only the root/system disk, not ephemeral or volume attachments -- but you can snapshot those separately.
:::
