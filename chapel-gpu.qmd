...
you write arrays of pixels to a PNG file. The following code -- when added to the non-GPU code
`juliaSetSerial.chpl` -- writes the array `stability` to a file `2000.png` assuming you
