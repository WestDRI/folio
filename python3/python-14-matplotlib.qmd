...
There are hundreds of visualization libraries in Python. Check out this [diagram of the Python Visualization
...
[3D scientific visualizations](https://ccvis.netlify.app){target="_blank"}, and in the Alliance federation we provide
...
- [Plotly](https://plotly.com/python){target="_blank"} if you want HTML5 interactivity
- [Bokeh](https://demo.bokeh.org){target="_blank"} also plots into interactive HTML5
- [Seaborn](https://seaborn.pydata.org/examples){target="_blank"} is based on matplotlib with a high-level interface
  for statistical graphics
- [Plotnine](https://plotnine.org/gallery){target="_blank"} is an implementation of "Grammar of Graphics" in
...
For other plot types, click on any example in the [Matplotlib
gallery](https://matplotlib.org/gallery){target="_blank"}.
...
gallery](https://matplotlib.org/stable/gallery/mplot3d){target="_blank"} to see the code behind
that plot. Try pasting it into your Jupyter notebook and running it, and try to modify the code.
