...
./bin/CFullExampleV2 catalyst_pipeline.py                # serial run, just terminal output

salloc --ntasks=2 --time=0:15:0 --mem-per-cpu=3600
mpirun -np 2 ./bin/CFullExampleV2 catalyst_pipeline.py   # parallel run, just terminal output
                                                         # each MPI rank will print below
                                                         # can see in `bounds`
```
