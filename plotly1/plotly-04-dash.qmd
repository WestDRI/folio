...
1. spin up a Dash app on your own VM -- you can build one for free on [one of our Clouds
   systems](https://docs.alliancecan.ca/wiki/Cloud#Cloud_systems){target="_blank"}, or pay to use a commercial
   cloud,
1. run a Dash app on your research group's existing web server using an unused port,
...
| State management | client-side via React.js | stateful (server-side session management) |
...
| Best for | large-scale enterprise apps with custom JS/CSS | rapid prototyping and complex data dependencies |
