...
Next, we try [Dash VTK](https://dash.plotly.com/vtk){target="_blank"} that runs a custom VTK pipeline on the
server side and pushes the visualization to the client:
            ...
            html.Div(
                dash_vtk.View(
                    dash_vtk.GeometryRepresentation(
                        ...
                        colorMapPreset="Viridis (matplotlib)",
                    )
                ),
