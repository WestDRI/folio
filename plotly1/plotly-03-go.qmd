...
the corresponding `type` element. **This variable `line` completely describes our plot!*** Then we create a
list of such objects and pass it to the plotting routine.
