...
**December 19<sup>th</sup>, 2024, 10:00am–noon Pacific Time**

You can find this page at &nbsp;
<span style="font-size:1.8em;">https://folio.vastcloud.org/bash-questions</span>
...
- <https://mint.westdri.ca/bash/intro_aliases>{target="_blank"}
- <https://mint.westdri.ca/bash/molecules/intro_script>{target="_blank"}
...
::: {.callout-note}
`fzf` in CVMFS does not seem to have been compiled with completion support. To enable it on the training
...
- <https://mint.westdri.ca/bash/intro_modern>{target="_blank"} describes eza, bat, ripgrep, fd, autojump
- <https://mint.westdri.ca/bash/intro_zsh>{target="_blank"} describes useful plugins, auto-suggestions, syntax highlighting
