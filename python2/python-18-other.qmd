...
* [Matplotlib gallery](https://matplotlib.org/stable/gallery){target="_blank"}
* [NumPy](http://www.numpy.org){target="_blank"} scientific computing package
* [SciPy](http://www.scipy.org){target="_blank"} collection of scientific utilities
* [Pandas](http://pandas.pydata.org){target="_blank"} library
* [Xarray documentation](https://docs.xarray.dev){target="_blank"}
