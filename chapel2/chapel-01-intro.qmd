...
3. multi-locale `chapel-ofi` for older OmniPath clusters (keeping for use on Cedar at SFU)
...
::: {.callout-note}
On our current training cluster, for reasons I'll explain during the course, you may want to run the following
command whenever you open a new shell:
```sh
