...
1. a tightly coupled problem such as **heat diffusion** that requires communication between tasks at each step
   of the iteration -- [this is where Chapel really shines]{style="color: blue;"}, as it hides all
...
For other format specifiers, check the table at
<https://chapel-lang.org/docs/modules/standard/IO/FormattedIO.html>{target="_blank"}.
