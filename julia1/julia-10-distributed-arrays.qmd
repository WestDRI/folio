...
@spawnat 5 data.localpart[1,1] = 2.5   # success: can write locally
data
```
...
```jl
n = 100;
a = dzeros(n,n,n);      # 100^3 distributed array of 0's
b = dones(n,n,n);       # 100^3 distributed array of 1's
c = drand(n,n,n);       # 100^3 uniform [0,1]
d = drandn(n,n,n);      # 100^3 drawn from a Gaussian distribution
d[1:10,1:10,1]
e = dfill(1.5,n,n,n);   # 100^3 fixed value
```
...
memory usage, but not too large not to exceed physical memory and not to affect other workshop participants.
:::
